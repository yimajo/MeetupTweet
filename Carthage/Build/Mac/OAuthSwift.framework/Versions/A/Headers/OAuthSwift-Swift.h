...
- (NSData * _Nonnull)multiPartBodyFrom:(NSDictionary<NSString *, id> * _Nonnull)parameters boundary:(NSString * _Nonnull)boundary SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_DEPRECATED_MSG("-init is unavailable");
@end
...
- (nullable instancetype)initWithNibName:(NSNibName _Nullable)nibNameOrNil bundle:(NSBundle * _Nullable)nibBundleOrNil OBJC_DESIGNATED_INITIALIZER;
